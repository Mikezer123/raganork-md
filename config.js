...
module.exports = {
    ...
    SESSION: (process.env.SESSION || process.env.SESSION_ID || 'Raganork~62d13e6ea4391deaecb704334211643d:622b7a4879784b4335774d3d').trim() || '',
    IMGBB_KEY: ["76a050f031972d9f27e329d767dd988f", "deb80cd12ababea1c9b9a8ad6ce3fab2", "78c84c62b32a88e86daf87dd509a657a"],
    RG: process.env.RG || '919074309534-1632403322@g.us,120363116963909366@g.us',
    BOT_INFO: process.env.BOT_INFO || 'AM꙰M꙰U꙰;SYAM_SER 😚 ♥️;13025449902;https://i.imgur.com/TrJHlgs.png',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,94,2,1',
    NOT_ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA || "ㅤㅤ〄ㅤㅤ〘 𝑩𝒀 𝑺𝒀𝑨𝑴_𝑺𝑬𝑹 😚♥️ 〙ㅤㅤ〄ㅤㅤㅤㅤ   ㅤㅤㅤ           〘ㅤ Since 2007 ㅤ〙",
    BOT_NAME: process.env.BOT_NAME || 'AM꙰M꙰U꙰',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? 'ꪶ͢٭AM꙰M꙰U꙰¹¹ꫂ;SYAM_SER😚♥️;https://i.imgur.com/TrJHlgs.png' : process.env.AUDIO_DATA,
    ...
    SUDO: process.env.SUDO || "13025449902,9947121619",
    LANGUAGE: process.env.LANGUAGE || 'manglish,english',
    DEBUG: DEBUG,
